...
/**
 * Contains tests to ensure the accuracy of the PyramidSolitaireTextualController class.
 */
public class ControllerTest {
  ...
  /**
   * Tests that a null rd fields in the Controller constructor
   *  correctly throws an exception.
   */
  @Test (expected = IllegalArgumentException.class)
  public void testNullRdConstructor() {
    controller = new PyramidSolitaireTextualController(null, new StringBuilder());
  }

  /**
   * Tests that a null ap field in the constructor correctly throws an exception.
   */
  @Test (expected = IllegalArgumentException.class)
  public void testNullApConstructor() {
    controller = new PyramidSolitaireTextualController(new StringReader("a"), null);
  }
